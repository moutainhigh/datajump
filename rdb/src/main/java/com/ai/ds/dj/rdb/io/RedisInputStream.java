...
import com.ai.ds.dj.rdb.stream.ByteArrayInputStream;
...
public class RedisInputStream extends InputStream {
    ...
    public RedisInputStream(ByteArray arrays) {
        this(new ByteArrayInputStream(arrays));
    }
    ...
    public RedisInputStream( final InputStream input, int len) {
        this.in = input;
