...
public class ByteArrayMap implements Map<byte[], byte[]>, Serializable {
    ...
    private final class EntryIterator implements Iterator<Entry<byte[], byte[]>> {

        private final Iterator<Entry<Element, Element>> iterator = map.entrySet().iterator();
        ...
        public Entry<byte[], byte[]> next() {
            Entry<Element, Element> v = iterator.next();
    ...
    public static final class Node implements Entry<byte[], byte[]>, Serializable {
        private static final long serialVersionUID = 1L;
